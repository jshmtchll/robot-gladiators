...
var startGame = function() {
    ...
    for (var i = 0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
            // let player know what round they're in, remember that arrays start at 0 so it needs to have a 1 added to it
            ...
            // if player is still alive and were not the last enemy in the array
...
var shop = function() {
    //ask player what they'd likke to do
